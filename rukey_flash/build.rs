...
fn main() {
    for file in std::fs::read_dir("../rukey_firmware")
        .unwrap()
        .chain(std::fs::read_dir("../rukey_config").unwrap())
    {
    ...
    let firmware_dir = "../rukey_firmware";
    ...
    let firmware_path =
        format!("../../rukey_firmware/target/thumbv6m-none-eabi/{profile}/rukey_firmware");
