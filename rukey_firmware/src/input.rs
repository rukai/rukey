...
impl RukeyInputState {
    ...
    fn is_pressed(&self, check: RukeyInput) -> bool {
        match check {
            ...
            RukeyInput::LeftRow5Col0 => self.pressed[5][6],
            RukeyInput::LeftRow5Col1 => self.pressed[5][5],
            RukeyInput::LeftRow5Col2 => self.pressed[5][4],
            RukeyInput::LeftRow5Col3 => self.pressed[5][3],
            RukeyInput::LeftRow5Col4 => self.pressed[5][2],
            RukeyInput::RightRow5Col4 => self.pressed[5][7],
            RukeyInput::RightRow5Col3 => self.pressed[5][8],
            RukeyInput::RightRow5Col2 => self.pressed[5][9],
            RukeyInput::RightRow5Col1 => self.pressed[5][10],
            RukeyInput::RightRow5Col0 => self.pressed[5][11],
        }
    }
}
