...
impl RukeyInput {
    pub fn from_string_kebab(s: &str) -> Option<Self> {
        match s {
            "left-row0-col0" => Some(Self::LeftRow0Col0),
            "left-row0-col1" => Some(Self::LeftRow0Col1),
            "left-row0-col2" => Some(Self::LeftRow0Col2),
            "left-row0-col3" => Some(Self::LeftRow0Col3),
            "left-row0-col4" => Some(Self::LeftRow0Col4),
            "left-row0-col5" => Some(Self::LeftRow0Col5),
            "left-row0-col6" => Some(Self::LeftRow0Col6),
            "right-row0-col6" => Some(Self::RightRow0Col6),
            "right-row0-col5" => Some(Self::RightRow0Col5),
            "right-row0-col4" => Some(Self::RightRow0Col4),
            "right-row0-col3" => Some(Self::RightRow0Col3),
            "right-row0-col2" => Some(Self::RightRow0Col2),
            "right-row0-col1" => Some(Self::RightRow0Col1),
            "right-row0-col0" => Some(Self::RightRow0Col0),
            "left-row1-col0" => Some(Self::LeftRow1Col0),
            "left-row1-col1" => Some(Self::LeftRow1Col1),
            "left-row1-col2" => Some(Self::LeftRow1Col2),
            "left-row1-col3" => Some(Self::LeftRow1Col3),
            "left-row1-col4" => Some(Self::LeftRow1Col4),
            "left-row1-col5" => Some(Self::LeftRow1Col5),
            "left-row1-col6" => Some(Self::LeftRow1Col6),
            "right-row1-col6" => Some(Self::RightRow1Col6),
            "right-row1-col5" => Some(Self::RightRow1Col5),
            "right-row1-col4" => Some(Self::RightRow1Col4),
            "right-row1-col3" => Some(Self::RightRow1Col3),
            "right-row1-col2" => Some(Self::RightRow1Col2),
            "right-row1-col1" => Some(Self::RightRow1Col1),
            "right-row1-col0" => Some(Self::RightRow1Col0),
            "left-row2-col0" => Some(Self::LeftRow2Col0),
            "left-row2-col1" => Some(Self::LeftRow2Col1),
            "left-row2-col2" => Some(Self::LeftRow2Col2),
            "left-row2-col3" => Some(Self::LeftRow2Col3),
            "left-row2-col4" => Some(Self::LeftRow2Col4),
            "left-row2-col5" => Some(Self::LeftRow2Col5),
            "left-row2-col6" => Some(Self::LeftRow2Col6),
            "right-row2-col6" => Some(Self::RightRow2Col6),
            "right-row2-col5" => Some(Self::RightRow2Col5),
            "right-row2-col4" => Some(Self::RightRow2Col4),
            "right-row2-col3" => Some(Self::RightRow2Col3),
            "right-row2-col2" => Some(Self::RightRow2Col2),
            "right-row2-col1" => Some(Self::RightRow2Col1),
            "right-row2-col0" => Some(Self::RightRow2Col0),
            "left-row3-col0" => Some(Self::LeftRow3Col0),
            "left-row3-col1" => Some(Self::LeftRow3Col1),
            "left-row3-col2" => Some(Self::LeftRow3Col2),
            "left-row3-col3" => Some(Self::LeftRow3Col3),
            "left-row3-col4" => Some(Self::LeftRow3Col4),
            "left-row3-col5" => Some(Self::LeftRow3Col5),
            "right-row3-col5" => Some(Self::RightRow3Col5),
            "right-row3-col4" => Some(Self::RightRow3Col4),
            "right-row3-col3" => Some(Self::RightRow3Col3),
            "right-row3-col2" => Some(Self::RightRow3Col2),
            "right-row3-col1" => Some(Self::RightRow3Col1),
            "right-row3-col0" => Some(Self::RightRow3Col0),
            "left-row4-col0" => Some(Self::LeftRow4Col0),
            "left-row4-col1" => Some(Self::LeftRow4Col1),
            "left-row4-col2" => Some(Self::LeftRow4Col2),
            "left-row4-col3" => Some(Self::LeftRow4Col3),
            "left-row4-col4" => Some(Self::LeftRow4Col4),
            "right-row4-col4" => Some(Self::RightRow4Col4),
            "right-row4-col3" => Some(Self::RightRow4Col3),
            "right-row4-col2" => Some(Self::RightRow4Col2),
            "right-row4-col1" => Some(Self::RightRow4Col1),
            "right-row4-col0" => Some(Self::RightRow4Col0),
            "left-thumb-row0-col0" => Some(Self::LeftThumbRow0Col0),
            "left-thumb-row0-col1" => Some(Self::LeftThumbRow0Col1),
            "left-thumb-row1-col0" => Some(Self::LeftThumbRow1Col0),
            "left-thumb-row1-col1" => Some(Self::LeftThumbRow1Col1),
            "left-thumb-row1-col2" => Some(Self::LeftThumbRow1Col2),
            "right-thumb-row0-col0" => Some(Self::RightThumbRow0Col0),
            "right-thumb-row0-col1" => Some(Self::RightThumbRow0Col1),
            "right-thumb-row1-col0" => Some(Self::RightThumbRow1Col0),
            "right-thumb-row1-col1" => Some(Self::RightThumbRow1Col1),
            "right-thumb-row1-col2" => Some(Self::RightThumbRow1Col2),
            _ => None,
        }
    }
}
