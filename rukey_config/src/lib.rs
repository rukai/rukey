...
impl RukeyInput {
    pub fn from_string_kebab(s: &str) -> Option<Self> {
        match s {
            ...
            "left-row5-col0" => Some(Self::LeftRow5Col0),
            "left-row5-col1" => Some(Self::LeftRow5Col1),
            "left-row5-col2" => Some(Self::LeftRow5Col2),
            "left-row5-col3" => Some(Self::LeftRow5Col3),
            "left-row5-col4" => Some(Self::LeftRow5Col4),
            "right-row5-col4" => Some(Self::RightRow5Col4),
            "right-row5-col3" => Some(Self::RightRow5Col3),
            "right-row5-col2" => Some(Self::RightRow5Col2),
            "right-row5-col1" => Some(Self::RightRow5Col1),
            "right-row5-col0" => Some(Self::RightRow5Col0),
            _ => None,
        }
    }
}
